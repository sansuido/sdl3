...
//const SDL_FILE = __FILE_NAME__;
//const SDL_ASSERT_FILE = SDL_FILE;
//const SDL_LINE = __LINE__;
const SDL_NULL_WHILE_LOOP_CONDITION = 0;
//const SDL_disabled_assert = (condition) do { (void) sizeof ((condition) ? 1 : 0); } while (SDL_NULL_WHILE_LOOP_CONDITION);
...
//const SDL_enabled_assert = (condition) do { while ( !(condition) ) { static struct SDL_AssertData sdl_assert_data = { false, 0, #condition, NULL, 0, NULL, NULL }; const SDL_AssertState sdl_assert_state = SDL_ReportAssertion(&sdl_assert_data, SDL_FUNCTION, SDL_ASSERT_FILE, SDL_LINE); if (sdl_assert_state == SDL_ASSERTION_RETRY) { continue; } } while (SDL_NULL_WHILE_LOOP_CONDITION);
...
//const SDL_RESTRICT = __restrict;
//const SDL_HAS_BUILTIN = (x) __has_builtin(x);
//const SDL_HAS_EXTENSION = (x) __has_extension(x);
//const SDL_ALIGNED = (x) __attribute__((aligned(x)));
...
const SDL_HINT_DOS_ALLOW_DIRECT_FRAMEBUFFER =
    'SDL_DOS_ALLOW_DIRECT_FRAMEBUFFER';
const SDL_HINT_INVALID_PARAM_CHECKS = 'SDL_INVALID_PARAM_CHECKS';
...
const SDL_HINT_ENABLE_STEAM_SCREEN_KEYBOARD =
...
const SDL_HINT_HIDAPI_LIBUSB_GAMECUBE = 'SDL_HIDAPI_LIBUSB_GAMECUBE';
...
const SDL_HINT_JOYSTICK_DRUM_DEVICES = 'SDL_JOYSTICK_DRUM_DEVICES';
...
const SDL_HINT_JOYSTICK_GAMEINPUT_RAW = 'SDL_JOYSTICK_GAMEINPUT_RAW';
...
const SDL_HINT_JOYSTICK_GUITAR_DEVICES = 'SDL_JOYSTICK_GUITAR_DEVICES';
...
const SDL_HINT_KMSDRM_ATOMIC = 'SDL_KMSDRM_ATOMIC';
...
const SDL_HINT_OPENGL_FORCE_SRGB_FRAMEBUFFER =
...
const SDL_HINT_PS2_GS_WIDTH = 'SDL_PS2_GS_WIDTH';
const SDL_HINT_PS2_GS_HEIGHT = 'SDL_PS2_GS_HEIGHT';
const SDL_HINT_PS2_GS_PROGRESSIVE = 'SDL_PS2_GS_PROGRESSIVE';
const SDL_HINT_PS2_GS_MODE = 'SDL_PS2_GS_MODE';
...
const SDL_HINT_VIDEO_X11_ENABLE_XSYNC_EXT = 'SDL_VIDEO_X11_ENABLE_XSYNC_EXT';
...
const SDL_HINT_VISIONOS_HDR_HEADROOM_UI = 'SDL_VISIONOS_HDR_HEADROOM_UI';
...
const SDL_HINT_WINDOWS_RAW_KEYBOARD_EXCLUDE_HOTKEYS =
    'SDL_WINDOWS_RAW_KEYBOARD_EXCLUDE_HOTKEYS';
const SDL_HINT_WINDOWS_RAW_KEYBOARD_INPUTSINK =
    'SDL_WINDOWS_RAW_KEYBOARD_INPUTSINK';
const SDL_HINT_WINDOWS_RAW_MOUSE_NOLEGACY = 'SDL_WINDOWS_RAW_MOUSE_NOLEGACY';
...
const SDL_COLORSPACE_YUV_DEFAULT = SDL_COLORSPACE_BT601_LIMITED;
...
const SDL_PLATFORM_DOS = 1;
const SDL_PLATFORM_HURD = 1;
//const SDL_power_h_ = ;
...
const SDL_REVISION =
    'SDL-3.5.0-release-3.4.0-1180-g8319d69f7 (" SDL_VENDOR_INFO ")';
...
//const SDL_PRILLX = SDL_PRILL_PREFIX "X";
const SDL_PRISZ_PREFIX = 'z';
//const SDL_PRISZu = SDL_PRISZ_PREFIX "u";
//const SDL_PRISZx = SDL_PRISZ_PREFIX "x";
//const SDL_PRISZX = SDL_PRISZ_PREFIX "X";
...
//const SDL_stack_free = (data) ((void)(data));
...
//const SDL_iconv_utf8_ucs2 = (S) SDL_reinterpret_cast(Uint16 *, SDL_iconv_string("UCS-2", "UTF-8", S, SDL_strlen(S)+1));
//const SDL_iconv_utf8_ucs4 = (S) SDL_reinterpret_cast(Uint32 *, SDL_iconv_string("UCS-4", "UTF-8", S, SDL_strlen(S)+1));
//const SDL_iconv_wchar_utf8 = (S) SDL_iconv_string("UTF-8", "WCHAR_T", SDL_reinterpret_cast(const char *, S), (SDL_wcslen(S)+1)*sizeof(wchar_t));
...
const SDL_FORMFACTOR_UNKNOWN = 0;
const SDL_FORMFACTOR_DESKTOP = 0 + 1;
const SDL_FORMFACTOR_LAPTOP = 0 + 2;
const SDL_FORMFACTOR_PHONE = 0 + 3;
const SDL_FORMFACTOR_TABLET = 0 + 4;
const SDL_FORMFACTOR_CONSOLE = 0 + 5;
const SDL_FORMFACTOR_HANDHELD = 0 + 6;
const SDL_FORMFACTOR_WATCH = 0 + 7;
const SDL_FORMFACTOR_TV = 0 + 8;
const SDL_FORMFACTOR_HEADSET = 0 + 9;
const SDL_FORMFACTOR_CAR = 0 + 10;
...
const SDL_SANDBOX_LOMIRI = 0 + 5;
const SDL_PROP_GLOBAL_SYSTEM_UBUNTU_TOUCH_APPID_STRING =
    'SDL.system.ubuntu_touch.appid';
const SDL_PROP_GLOBAL_SYSTEM_UBUNTU_TOUCH_HOOK_STRING =
    'SDL.system.ubuntu_touch.hook';
const SDL_PROP_GLOBAL_SYSTEM_UBUNTU_TOUCH_APP_VERSION_STRING =
    'SDL.system.ubuntu_touch.app_version';
//const SDL_thread_h_ = ;
...
class SdlkHint {
  ...
  static const dosAllowDirectFramebuffer =
      SDL_HINT_DOS_ALLOW_DIRECT_FRAMEBUFFER;
  static const invalidParamChecks = SDL_HINT_INVALID_PARAM_CHECKS;
  ...
  static const enableSteamScreenKeyboard =
  ...
  static const hidapiLibusbGamecube = SDL_HINT_HIDAPI_LIBUSB_GAMECUBE;
  ...
  static const joystickDrumDevices = SDL_HINT_JOYSTICK_DRUM_DEVICES;
  ...
  static const joystickGameinputRaw = SDL_HINT_JOYSTICK_GAMEINPUT_RAW;
  ...
  static const joystickGuitarDevices = SDL_HINT_JOYSTICK_GUITAR_DEVICES;
  ...
  static const kmsdrmAtomic = SDL_HINT_KMSDRM_ATOMIC;
  ...
  static const openglForceSrgbFramebuffer =
  ...
  static const ps2GsWidth = SDL_HINT_PS2_GS_WIDTH;
  static const ps2GsHeight = SDL_HINT_PS2_GS_HEIGHT;
  static const ps2GsProgressive = SDL_HINT_PS2_GS_PROGRESSIVE;
  static const ps2GsMode = SDL_HINT_PS2_GS_MODE;
  ...
  static const videoX11EnableXsyncExt = SDL_HINT_VIDEO_X11_ENABLE_XSYNC_EXT;
  ...
  static const visionosHdrHeadroomUi = SDL_HINT_VISIONOS_HDR_HEADROOM_UI;
  ...
  static const windowsRawKeyboardExcludeHotkeys =
      SDL_HINT_WINDOWS_RAW_KEYBOARD_EXCLUDE_HOTKEYS;
  static const windowsRawKeyboardInputsink =
      SDL_HINT_WINDOWS_RAW_KEYBOARD_INPUTSINK;
  static const windowsRawMouseNolegacy = SDL_HINT_WINDOWS_RAW_MOUSE_NOLEGACY;
...
class SdlkSandbox {
  ...
  static const lomiri = SDL_SANDBOX_LOMIRI;
}
