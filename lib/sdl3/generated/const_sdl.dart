...
//const SDL_SwapLE16 = (x) SwapOnlyIfNecessary(x);
//const SDL_SwapLE32 = (x) SwapOnlyIfNecessary(x);
//const SDL_SwapLE64 = (x) SwapOnlyIfNecessary(x);
//const SDL_SwapFloatLE = (x) SwapOnlyIfNecessary(x);
//const SDL_SwapBE16 = (x) SwapOnlyIfNecessary(x);
//const SDL_SwapBE32 = (x) SwapOnlyIfNecessary(x);
//const SDL_SwapBE64 = (x) SwapOnlyIfNecessary(x);
...
const SDL_HINT_RENDER_PS2_DYNAMIC_VSYNC = 'SDL_RENDER_PS2_DYNAMIC_VSYNC';
...
const SDL_HINT_PS2_DYNAMIC_VSYNC = SDL_HINT_RENDER_PS2_DYNAMIC_VSYNC;
...
const SDL_PROP_GLOBAL_SYSTEM_DATE_FORMAT_NUMBER = 'SDL.time.date_format';
const SDL_PROP_GLOBAL_SYSTEM_TIME_FORMAT_NUMBER = 'SDL.time.time_format';
//const SDL_timer_h_ = ;
...
//const SDL_VERSIONNUM = (major, minor, patch) ((major) << 24 | (minor) << 8 | (patch) << 0);
...
const SDL_WINDOW_MODAL = 0x00001000;
...
const SDL_PROP_DISPLAY_SDR_WHITE_POINT_FLOAT = 'SDL.display.SDR_white_point';
const SDL_PROP_DISPLAY_HDR_HEADROOM_FLOAT = 'SDL.display.HDR_headroom';
...
const SDL_PROP_WINDOW_CREATE_WAYLAND_SCALE_TO_DISPLAY_BOOLEAN =
