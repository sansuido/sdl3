...
//const SDL_gpu_h_ = ;
const SDL_GPU_PRIMITIVETYPE_POINTLIST = 0;
const SDL_GPU_PRIMITIVETYPE_LINELIST = 1;
const SDL_GPU_PRIMITIVETYPE_LINESTRIP = 2;
const SDL_GPU_PRIMITIVETYPE_TRIANGLELIST = 3;
const SDL_GPU_PRIMITIVETYPE_TRIANGLESTRIP = 4;
...
const SDL_GPU_TEXTUREFORMAT_INVALID = -1;
const SDL_GPU_TEXTUREFORMAT_R8G8B8A8_UNORM = -1 + 1;
const SDL_GPU_TEXTUREFORMAT_B8G8R8A8_UNORM = -1 + 2;
const SDL_GPU_TEXTUREFORMAT_B5G6R5_UNORM = -1 + 3;
const SDL_GPU_TEXTUREFORMAT_B5G5R5A1_UNORM = -1 + 4;
const SDL_GPU_TEXTUREFORMAT_B4G4R4A4_UNORM = -1 + 5;
const SDL_GPU_TEXTUREFORMAT_R10G10B10A2_UNORM = -1 + 6;
const SDL_GPU_TEXTUREFORMAT_R16G16_UNORM = -1 + 7;
const SDL_GPU_TEXTUREFORMAT_R16G16B16A16_UNORM = -1 + 8;
const SDL_GPU_TEXTUREFORMAT_R8_UNORM = -1 + 9;
const SDL_GPU_TEXTUREFORMAT_A8_UNORM = -1 + 10;
const SDL_GPU_TEXTUREFORMAT_BC1_UNORM = -1 + 11;
const SDL_GPU_TEXTUREFORMAT_BC2_UNORM = -1 + 12;
const SDL_GPU_TEXTUREFORMAT_BC3_UNORM = -1 + 13;
const SDL_GPU_TEXTUREFORMAT_BC7_UNORM = -1 + 14;
const SDL_GPU_TEXTUREFORMAT_R8G8_SNORM = -1 + 15;
const SDL_GPU_TEXTUREFORMAT_R8G8B8A8_SNORM = -1 + 16;
const SDL_GPU_TEXTUREFORMAT_R16_FLOAT = -1 + 17;
const SDL_GPU_TEXTUREFORMAT_R16G16_FLOAT = -1 + 18;
const SDL_GPU_TEXTUREFORMAT_R16G16B16A16_FLOAT = -1 + 19;
const SDL_GPU_TEXTUREFORMAT_R32_FLOAT = -1 + 20;
const SDL_GPU_TEXTUREFORMAT_R32G32_FLOAT = -1 + 21;
const SDL_GPU_TEXTUREFORMAT_R32G32B32A32_FLOAT = -1 + 22;
const SDL_GPU_TEXTUREFORMAT_R8_UINT = -1 + 23;
const SDL_GPU_TEXTUREFORMAT_R8G8_UINT = -1 + 24;
const SDL_GPU_TEXTUREFORMAT_R8G8B8A8_UINT = -1 + 25;
const SDL_GPU_TEXTUREFORMAT_R16_UINT = -1 + 26;
const SDL_GPU_TEXTUREFORMAT_R16G16_UINT = -1 + 27;
const SDL_GPU_TEXTUREFORMAT_R16G16B16A16_UINT = -1 + 28;
const SDL_GPU_TEXTUREFORMAT_R8G8B8A8_UNORM_SRGB = -1 + 29;
const SDL_GPU_TEXTUREFORMAT_B8G8R8A8_UNORM_SRGB = -1 + 30;
const SDL_GPU_TEXTUREFORMAT_BC3_UNORM_SRGB = -1 + 31;
const SDL_GPU_TEXTUREFORMAT_BC7_UNORM_SRGB = -1 + 32;
const SDL_GPU_TEXTUREFORMAT_D16_UNORM = -1 + 33;
const SDL_GPU_TEXTUREFORMAT_D24_UNORM = -1 + 34;
const SDL_GPU_TEXTUREFORMAT_D32_FLOAT = -1 + 35;
const SDL_GPU_TEXTUREFORMAT_D24_UNORM_S8_UINT = -1 + 36;
const SDL_GPU_TEXTUREFORMAT_D32_FLOAT_S8_UINT = -1 + 37;
const SDL_GPU_TEXTUREUSAGE_SAMPLER_BIT = 0x00000001;
const SDL_GPU_TEXTUREUSAGE_COLOR_TARGET_BIT = 0x00000002;
const SDL_GPU_TEXTUREUSAGE_DEPTH_STENCIL_TARGET_BIT = 0x00000004;
const SDL_GPU_TEXTUREUSAGE_GRAPHICS_STORAGE_READ_BIT = 0x00000008;
const SDL_GPU_TEXTUREUSAGE_COMPUTE_STORAGE_READ_BIT = 0x00000020;
const SDL_GPU_TEXTUREUSAGE_COMPUTE_STORAGE_WRITE_BIT = 0x00000040;
...
const SDL_GPU_BUFFERUSAGE_VERTEX_BIT = 0x00000001;
const SDL_GPU_BUFFERUSAGE_INDEX_BIT = 0x00000002;
const SDL_GPU_BUFFERUSAGE_INDIRECT_BIT = 0x00000004;
const SDL_GPU_BUFFERUSAGE_GRAPHICS_STORAGE_READ_BIT = 0x00000008;
const SDL_GPU_BUFFERUSAGE_COMPUTE_STORAGE_READ_BIT = 0x00000020;
const SDL_GPU_BUFFERUSAGE_COMPUTE_STORAGE_WRITE_BIT = 0x00000040;
...
const SDL_GPU_SHADERFORMAT_INVALID = 0x00000000;
const SDL_GPU_SHADERFORMAT_SECRET = 0x00000001;
const SDL_GPU_SHADERFORMAT_SPIRV = 0x00000002;
const SDL_GPU_SHADERFORMAT_DXBC = 0x00000004;
const SDL_GPU_SHADERFORMAT_DXIL = 0x00000008;
const SDL_GPU_SHADERFORMAT_MSL = 0x00000010;
const SDL_GPU_SHADERFORMAT_METALLIB = 0x00000020;
const SDL_GPU_VERTEXELEMENTFORMAT_INT = 0;
const SDL_GPU_VERTEXELEMENTFORMAT_INT2 = 1;
const SDL_GPU_VERTEXELEMENTFORMAT_INT3 = 2;
const SDL_GPU_VERTEXELEMENTFORMAT_INT4 = 3;
const SDL_GPU_VERTEXELEMENTFORMAT_UINT = 4;
const SDL_GPU_VERTEXELEMENTFORMAT_UINT2 = 5;
const SDL_GPU_VERTEXELEMENTFORMAT_UINT3 = 6;
const SDL_GPU_VERTEXELEMENTFORMAT_UINT4 = 7;
const SDL_GPU_VERTEXELEMENTFORMAT_FLOAT = 8;
const SDL_GPU_VERTEXELEMENTFORMAT_FLOAT2 = 9;
const SDL_GPU_VERTEXELEMENTFORMAT_FLOAT3 = 10;
const SDL_GPU_VERTEXELEMENTFORMAT_FLOAT4 = 11;
const SDL_GPU_VERTEXELEMENTFORMAT_BYTE2 = 12;
const SDL_GPU_VERTEXELEMENTFORMAT_BYTE4 = 13;
const SDL_GPU_VERTEXELEMENTFORMAT_UBYTE2 = 14;
const SDL_GPU_VERTEXELEMENTFORMAT_UBYTE4 = 15;
const SDL_GPU_VERTEXELEMENTFORMAT_BYTE2_NORM = 16;
const SDL_GPU_VERTEXELEMENTFORMAT_BYTE4_NORM = 17;
const SDL_GPU_VERTEXELEMENTFORMAT_UBYTE2_NORM = 18;
const SDL_GPU_VERTEXELEMENTFORMAT_UBYTE4_NORM = 19;
const SDL_GPU_VERTEXELEMENTFORMAT_SHORT2 = 20;
const SDL_GPU_VERTEXELEMENTFORMAT_SHORT4 = 21;
const SDL_GPU_VERTEXELEMENTFORMAT_USHORT2 = 22;
const SDL_GPU_VERTEXELEMENTFORMAT_USHORT4 = 23;
const SDL_GPU_VERTEXELEMENTFORMAT_SHORT2_NORM = 24;
const SDL_GPU_VERTEXELEMENTFORMAT_SHORT4_NORM = 25;
const SDL_GPU_VERTEXELEMENTFORMAT_USHORT2_NORM = 26;
const SDL_GPU_VERTEXELEMENTFORMAT_USHORT4_NORM = 27;
const SDL_GPU_VERTEXELEMENTFORMAT_HALF2 = 28;
const SDL_GPU_VERTEXELEMENTFORMAT_HALF4 = 29;
...
const SDL_GPU_COMPAREOP_NEVER = 0;
const SDL_GPU_COMPAREOP_LESS = 1;
const SDL_GPU_COMPAREOP_EQUAL = 2;
const SDL_GPU_COMPAREOP_LESS_OR_EQUAL = 3;
const SDL_GPU_COMPAREOP_GREATER = 4;
const SDL_GPU_COMPAREOP_NOT_EQUAL = 5;
const SDL_GPU_COMPAREOP_GREATER_OR_EQUAL = 6;
const SDL_GPU_COMPAREOP_ALWAYS = 7;
const SDL_GPU_STENCILOP_KEEP = 0;
const SDL_GPU_STENCILOP_ZERO = 1;
const SDL_GPU_STENCILOP_REPLACE = 2;
const SDL_GPU_STENCILOP_INCREMENT_AND_CLAMP = 3;
const SDL_GPU_STENCILOP_DECREMENT_AND_CLAMP = 4;
const SDL_GPU_STENCILOP_INVERT = 5;
const SDL_GPU_STENCILOP_INCREMENT_AND_WRAP = 6;
const SDL_GPU_STENCILOP_DECREMENT_AND_WRAP = 7;
const SDL_GPU_BLENDOP_ADD = 0;
const SDL_GPU_BLENDOP_SUBTRACT = 1;
const SDL_GPU_BLENDOP_REVERSE_SUBTRACT = 2;
const SDL_GPU_BLENDOP_MIN = 3;
const SDL_GPU_BLENDOP_MAX = 4;
const SDL_GPU_BLENDFACTOR_ZERO = 0;
const SDL_GPU_BLENDFACTOR_ONE = 1;
const SDL_GPU_BLENDFACTOR_SRC_COLOR = 2;
const SDL_GPU_BLENDFACTOR_ONE_MINUS_SRC_COLOR = 3;
const SDL_GPU_BLENDFACTOR_DST_COLOR = 4;
const SDL_GPU_BLENDFACTOR_ONE_MINUS_DST_COLOR = 5;
const SDL_GPU_BLENDFACTOR_SRC_ALPHA = 6;
const SDL_GPU_BLENDFACTOR_ONE_MINUS_SRC_ALPHA = 7;
const SDL_GPU_BLENDFACTOR_DST_ALPHA = 8;
const SDL_GPU_BLENDFACTOR_ONE_MINUS_DST_ALPHA = 9;
const SDL_GPU_BLENDFACTOR_CONSTANT_COLOR = 10;
const SDL_GPU_BLENDFACTOR_ONE_MINUS_CONSTANT_COLOR = 11;
const SDL_GPU_BLENDFACTOR_SRC_ALPHA_SATURATE = 12;
const SDL_GPU_COLORCOMPONENT_R_BIT = 0x00000001;
const SDL_GPU_COLORCOMPONENT_G_BIT = 0x00000002;
const SDL_GPU_COLORCOMPONENT_B_BIT = 0x00000004;
const SDL_GPU_COLORCOMPONENT_A_BIT = 0x00000008;
...
const SDL_GPU_DRIVER_INVALID = -1;
const SDL_GPU_DRIVER_SECRET = -1 + 1;
const SDL_GPU_DRIVER_VULKAN = -1 + 2;
const SDL_GPU_DRIVER_D3D11 = -1 + 3;
const SDL_GPU_DRIVER_D3D12 = -1 + 4;
const SDL_GPU_DRIVER_METAL = -1 + 5;
...
const SDL_PROP_GPU_DEVICE_CREATE_SHADERS_SECRET_BOOL =
    'SDL.gpu.device.create.shaders.secret';
...
const SDL_LOG_CATEGORY_GPU = 7;
const SDL_LOG_CATEGORY_INPUT = 8;
const SDL_LOG_CATEGORY_TEST = 9;
const SDL_LOG_CATEGORY_RESERVED1 = 10;
const SDL_LOG_CATEGORY_RESERVED2 = 11;
const SDL_LOG_CATEGORY_RESERVED3 = 12;
const SDL_LOG_CATEGORY_RESERVED4 = 13;
const SDL_LOG_CATEGORY_RESERVED5 = 14;
const SDL_LOG_CATEGORY_RESERVED6 = 15;
const SDL_LOG_CATEGORY_RESERVED7 = 16;
const SDL_LOG_CATEGORY_RESERVED8 = 17;
const SDL_LOG_CATEGORY_RESERVED9 = 18;
const SDL_LOG_CATEGORY_RESERVED10 = 19;
const SDL_LOG_CATEGORY_CUSTOM = 20;
...
//const SDL_AtomicGetPtr = SDL_AtomicGetPointer;
//const SDL_AtomicLock = SDL_LockSpinlock;
//const SDL_AtomicSetPtr = SDL_AtomicSetPointer;
