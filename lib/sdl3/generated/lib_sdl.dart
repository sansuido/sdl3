...
typedef SdlAppQuitFunc = Void Function(Pointer<Void> appstate, Int32 result);
...
typedef SdlMallocFunc = Pointer<Void> Function(Size size);

// typedef void *(SDLCALL *SDL_calloc_func)(size_t nmemb, size_t size)
typedef SdlCallocFuncDart = Pointer<Void> Function(int nmemb, int size);
...
typedef SdlFreeFuncDart = void Function(Pointer<Void> mem);
typedef SdlFreeFunc = Void Function(Pointer<Void> mem);

// typedef int (SDLCALL *SDL_CompareCallback)(const void *a, const void *b)
typedef SdlCompareCallbackDart = int Function(Pointer<Void> a, Pointer<Void> b);
...
typedef SdlTlsDestructorCallbackDart = void Function(Pointer<Void> value);
