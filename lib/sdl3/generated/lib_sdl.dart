...
final libSdl3 = dylib.SdlDynamicLibraryService().open('SDL3');
...
typedef SdlClipboardCleanupCallbackDart =
    void Function(Pointer<NativeType> userdata);
typedef SdlClipboardCleanupCallback =
    Void Function(Pointer<NativeType> userdata);
...
typedef SdlAppInitFuncDart =
    int Function(
      Pointer<Pointer<NativeType>> appstate,
      int argc,
...
typedef SdlCompareCallbackDart =
    int Function(Pointer<NativeType> a, Pointer<NativeType> b);
typedef SdlCompareCallback =
...
typedef SdlIOsAnimationCallbackDart =
    void Function(Pointer<NativeType> userdata);
