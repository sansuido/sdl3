...
/// ```
/// {@category tray}
bool sdlIsTraySupported() {
  final sdlIsTraySupportedLookupFunction = _libSdl
      .lookupFunction<Uint8 Function(), int Function()>('SDL_IsTraySupported');
  return sdlIsTraySupportedLookupFunction() == 1;
}
