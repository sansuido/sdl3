...
extension SdlAudioStreamPointerEx on Pointer<SdlAudioStream> {
  ...
  /// ```
  int getFormat(Pointer<SdlAudioSpec> srcSpec, Pointer<SdlAudioSpec> dstSpec) {
  ...
  /// ```
  int setFormat(Pointer<SdlAudioSpec> srcSpec, Pointer<SdlAudioSpec> dstSpec) {
  ...
  /// ```
  int setFrequencyRatio(double ratio) {
  ...
  /// ```
  int setInputChannelMap(Pointer<Int32> chmap, int count) {
  ...
  /// ```
  int setOutputChannelMap(Pointer<Int32> chmap, int count) {
  ...
  /// ```
  int putData(Pointer<NativeType> buf, int len) {
  ...
  /// ```
  int setGetCallback(Pointer<NativeFunction<SdlAudioStreamCallback>> callback,
      Pointer<NativeType> userdata) {
  ...
  /// ```
  int setPutCallback(Pointer<NativeFunction<SdlAudioStreamCallback>> callback,
      Pointer<NativeType> userdata) {
