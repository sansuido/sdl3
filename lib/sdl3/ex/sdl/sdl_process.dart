...
extension SdlProcessEx on SdlProcess {
  ///
  ...
  }) => sdlxCreateProcess(args, pipeStdio: pipeStdio);
...
extension SdlProcessPointerEx on Pointer<SdlProcess> {
  ///
  ...
  /// ```
  /// {@category process}
  bool read(SdlxDataResult result) => sdlxReadProcess(this, result);
